...
const PrivacyPolicy: React.FC = () => {
    return (
        <>
            <Navbar />
            <div className="p-6 text-neutral-800 w-[90%] mx-auto py-28">
                <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
                <p className="mb-2">Last updated: June 23 2024</p>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-medium mb-1">Interpretation</h3>
                <p className="mb-4">
                    The words of which the initial letter is capitalized have meanings defined under
                    the following conditions. The following definitions shall have the same meaning
                    regardless of whether they appear in singular or in plural.
                </p>
                <h3 className="text-xl font-medium mb-1">Definitions</h3>
                <p className="mb-4">
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li>
                            ...
                            "Us", or "Our" in this Agreement) refers to Investor Psyche Evaluation,
                            C 442 ground floor, Defence Colony, New Delhi 110024.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Website</strong> refers to Investor Psyche Evaluation,
                            accessible from https://investorpsycheevaluation.com/
                        </li>
                        <li>
                ...
                <h3 className="text-xl font-medium mb-1">Types of Data Collected</h3>
                ...
                <p className="mb-4">
                    ...
                    device identifiers, and other diagnostic data. When You access the Service by or
                ...
                <h3 className="text-xl font-medium mb-1">Tracking Technologies and Cookies</h3>
                <p className="mb-4">
                ...
                <ul className="list-disc list-inside mb-4">
                    <li>
                        ...
                        with services available through the Website and to enable You to use some of
                        its features. They help to authenticate users and prevent fraudulent use of
                    ...
                    <li>
                        ...
                        Administered by: Us. Purpose: These Cookies allow us to remember choices You
                ...
                <p className="mb-4">
                    ...
                    than those from Your jurisdiction. Your consent to this Privacy Policy followed
                ...
                <p className="mb-4">
                    ...
                    delete certain information about You from within the Service. You may update,
                    ...
                    correct, or delete any personal information that You have provided to Us. Please
                ...
                <h3 className="text-xl font-medium mb-1">Business Transactions</h3>
                <p className="mb-4">
                    If the Company is involved in a merger, acquisition, or asset sale, Your
                    Personal Data may be transferred. We will provide notice before Your Personal
                    Data is transferred and becomes subject to a different Privacy Policy.
                </p>
                <h3 className="text-xl font-medium mb-1">Law enforcement</h3>
                <p className="mb-4">
                    Under certain circumstances, the Company may be required to disclose Your
                    Personal Data if required to do so by law or in response to valid requests by
                    public authorities (e.g., a court or a government agency).
                </p>
                <h3 className="text-xl font-medium mb-1">Other legal requirements</h3>
                <p className="mb-4">
                ...
                <p>
                    ...
                    <ul className="list-disc list-inside">
                        <li>
                            By email:{' '}
                            <a href="mailto:riapaulbose@gmail.com" className="underline">
                                riapaulbose@gmail.com
                            </a>
                        </li>
                    </ul>
                </p>
